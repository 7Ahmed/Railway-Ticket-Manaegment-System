...
public class Ticket {
  ...
  Ticket(){
	  stage= new Stage();
		stage.setTitle("Railway Ticket Reservation System");
		stage.setHeight(500);
		stage.setWidth(500);
	...
	private void addComponents() {
		...
		Text text = new Text("Railway Ticket Reservation System");
		...
		RadioButton eclass=new RadioButton("Economy Class");
		...
		confirmticket.setStyle("-fx-background-color: Grey; -fx-textfill: white;");
			...
			public void handle(ActionEvent arg0) {
				...
				else
				{
					try
					{
						...
						{
							Show.type = "Business Class";
							Show.price = Show.bussiness;
						}
						if(eclass.isSelected())
						{
							Show.type = "Economy Class";
							Show.price = Show.economy;
						}
						if(local.isSelected())
						{
							Show.type = "Local";
							Show.price = Show.local;
						}
